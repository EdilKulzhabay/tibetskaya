...
const cards = [
    ...
    {
        subtitle: "Франшизы для форматов 0,5 л, 1 л, 2 л, 5 л",
        titile: (
            <span>
                ФРАНШИЗА «ТИБЕТСКАЯ» <br /> ВОДА 0,5 ЛИТРА
            </span>
        ),
        list: [
            "Право использования бренда «Тибетская» вода",
    ...
    },
    {
        ...
        titile: (
            <span>
                ФРАНШИЗА «ТИБЕТСКАЯ» <br /> ВОДА 1 ЛИТР
            </span>
        ),
        list: [
            "Право использования бренда «Тибетская» вода",
    ...
    },
    {
        ...
        titile: (
            <span>
                ФРАНШИЗА «ТИБЕТСКАЯ» <br /> ВОДА 2 ЛИТРА
            </span>
        ),
        list: [
            "Право использования бренда «Тибетская» вода",
    ...
    },
    {
        ...
        titile: (
            <span>
                ФРАНШИЗА «ТИБЕТСКАЯ» <br /> ВОДА 5 ЛИТРОВ
            </span>
        ),
        list: [
            "Право использования бренда «Тибетская» вода",
...
const advantages = [
    ...
    },
    {
        ...
        text: "Открытие аква-маркетов в каждом районе города решает проблему невыгодной доставки в условиях пробок и малых объемов, обеспечивая быструю и эффективную доставку.",
    },
    {
    ...
    },
    {
        ...
        text: "Заказчики на дом ценят прежде всего скорость и эффективность. Быстрая доставка за час через аква-маркеты позволяет удовлетворить их потребности и установить долгосрочные отношения.",
    },
    {
    ...
    },
    {
        ...
        text: "Заказчики на дом могут быть уверены в постоянной доступности воды благодаря аква-маркетам в их жилых районах. Это создает доверие и лояльность к бренду.",
    },
    {
